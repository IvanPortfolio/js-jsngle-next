...
import { ServiceItem } from '@/app/components/services/Serviceitem';
        ...
        <Section title="My Services">
            <div className="grid grid-cols-1 2xl:grid-cols-3 gap-4">
                ...
                >
                    ...
                    applications that run on both iOS and Android from a single
                    code base. This approach allows for faster development,
                    easier maintenance, and reduced costs while providing a
