...
import { ProjectItem } from '@/app/projects/components/ProjectItem';
    ...
    return (
        <PageLayout title="My Projects">
            <div className="flex flex-col">
                ...
                >
                    Worked on a member platform for a leading US insurance
                    company designed to enable members to manage their insurance
                    plans and find appropriate medical care easily. The platform
                    serves as a comprehensive tool for users to access all their
                    health plan information and manage their health coverage
                    effectively.
                </ProjectItem>
                <ProjectItem
                ...
                >
                    Contributed to a comprehensive system aimed at optimizing
                    delivery services for both consumers and businesses for a UK
                    company. The system included parcel tracking, web and mobile
                    applications, a depot process management tool, and a B2B
                    partnership management tool, enhancing efficiency across the
                    delivery ecosystem.
                </ProjectItem>
                <ProjectItem
                ...
                >
                    Played a key role in the development of a collaboration tool
                    for a US company aimed at improving communication and
                    management within small teams. The project focused on
                    providing services and best practices to enhance team
                ...
                >
                    Developed an application for a German company designed to
                    optimize logistics processes. The application consisted of
                    three components: logistics network optimization (LNO), a
                    layout editor for warehouse process optimization, and a 3D
                    layout for constructing models of the warehouse layouts.
                </ProjectItem>
            </div>
        </PageLayout>
    );
